...
//       // Add event listener for task click (open modal)
...
//     // Store the task ID in a hidden input or data attribute for reference
...
// // Close Modal (Reset Form and Clear Edit State)
// function closeModal() {
//   taskModal.style.display = 'none';
//   taskForm.reset(); // Reset form fields
//   delete taskForm.dataset.editTaskId; // Clear edit state
// }
...
// // Reset modal title when adding a new task
// addTaskButton.addEventListener('click', () => {
...
// // Reset modal title and submit button text when adding a new task
// addTaskButton.addEventListener('click', () => {
//   document.getElementById('modalTitle').textContent = 'Create New Task';
